...
contract SatsukiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Satsuki Inu";
    ...
    address payable private _marketingAddress = payable(0xEf477f50Fa1824EFbd2dc6A5ed2D79718fBC243f);
